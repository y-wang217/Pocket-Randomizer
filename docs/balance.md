...
| `randomizer-21` · `0b2c2c`, 400 | `ai-7-tiers-reach-the-app`, table | RETUNE | 1.25% | **1.295** | **the baseline for the wild-strength and early-gym-levels patch**, 2026-09-25, measured on `claude/wild-pokemon-gym-balance-gpykz5` at `2edca76` — the protocol commit, before any code. Recorded because the head of the tree had no `table` row at this `contentHash`: the copy split moved it from `d4e080` without a benchmark, and the only `table` row on this prefix is `randomizer-20` · `b8b419`. Gym clear rates 77.2 / 77.6 / 63.4 / 71.2 / 67.5 / 76.9 / 47.1 / 83.3 on parties of 272 / 174 / 112 / 59 / 40 / 26 / 17 / 6. **272 of 400 runs reach gym 1**, so 128 die on the road of segment 1, which is the number the patch below is aimed at. Report not committed: same command, same prefix, at that commit |
| `randomizer-22` · `715122`, 400 | `ai-7-tiers-reach-the-app`, table | RETUNE | 3.25% | **2.223** | **wild two levels lower, gyms 1 to 3 one level lower**, 2026-09-25. Read against the row directly above, which is the same tree one commit earlier: **+0.93 mean gyms, a 72% rise, and completion 1.25% to 3.25%.** Gym clear rates 84.9 / 88.7 / 71.6 / 89.6 / 78.9 / 75.4 / 51.2 / 81.2 on parties of 325 / 248 / 190 / 115 / 90 / 65 / 41 / 16. The two levers are visible separately: **325 rather than 272 runs reach gym 1**, a road that killed 32% of runs before the first exam now kills 19%, and that is the wild column; gyms 1 and 2 clear +7.7pt and +11.1pt on the largest parties in the table, and that is the gym column. Gym 3 is +8.2pt on 190. The greedy bot fights every road battle at `easy` and the guaranteed wild step is the fight it loses most, so a two-level cut there compounds through every later column — gym 4 is +18.4pt on a party nearly twice the size. Deaths at gym 1 fell from 190 to 124 while gym 3 rose from 64 to 84, because more runs get there. `RANDOMIZER_VERSION` `-21` to `-22`, `contentHash` `0b2c2c` to `715122`; `generation.md` section 78. **Recorded, not chased.** Gym 1 at 84.9% is still under its ~90% hypothesis and full completion at 3.3% is still under 5%. Report `sim-reports/benchmarks/2026-09-25T03-27-14-445Z-gymrun-randomizer-22-400.json` |
