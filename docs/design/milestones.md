...
**Open, two items of six done. Eight rows filed before and during the tier; all
are ruled**, from the reading in
...
| M5.2 Map node card | open | — (**D29**, **D35** ruled; needs D35's bare-capability map) |
