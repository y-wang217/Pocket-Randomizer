...
| D46 | Patch 4.10.1, then M7.1's face | The map node kind is a word by D37 and D28, section 5 says it is a glyph, and 4.10.1 asks for the glyph: D37's option 2, a reversal of D28 | **open** |
...
**Open. Blocks patch 4.10.1 entirely. Filed 2026-09-25, before any code, from
