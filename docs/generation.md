...
## 30. The shop and moveset-variance patch: a category nothing drew, and a slot with no draw
...
### 30.1 Status moves were unreachable, not under-weighted
...
### 30.2 The shelf is a list of categories
...
### 30.3 The forced STAB slot got a window, and `stabBias` was measured and declined
...
### 30.4 What the benchmark said, and what it could not see
...
### 30.5 Seed-pinned tests, and the pattern they moved to
