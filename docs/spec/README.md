...
| [`gymrun-patch-mobile-seed-bar.md`](gymrun-patch-mobile-seed-bar.md) | patch prompt | `active` | | committed 2026-09-11 before any work. Supersedes the 4.5.2 phone rule that hid the seed bar for the whole run; the collapsed bar is recorded in `../generation.md` section 12j |
