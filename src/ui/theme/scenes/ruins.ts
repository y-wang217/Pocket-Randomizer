...
/** Broken columns far, fallen walls mid, a near arch, and a light that hovers among them. */
export const ruins: SceneArt = {
  ...
  drift:
    svg('<rect fill="var(--locale-glow)" x="2" y="2" width="2" height="2"/><rect fill="var(--locale-glow)" opacity="0.3" x="1" y="1" width="4" height="4"/>', '0 0 6 6'),
  motion: { kind: 'float', at: ['46%', '42%'] },
};
