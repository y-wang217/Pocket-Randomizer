...
/** Stalactites above, a rubble floor, one spark of light going by: the reference every other place was brought up to. */
export const cave: SceneArt = {
  ...
  drift:
    svg('<rect fill="var(--locale-glow)" x="2" y="2" width="2" height="2"/><rect fill="var(--locale-glow)" opacity="0.5" x="2" y="0" width="2" height="1"/>', '0 0 6 6'),
  motion: { kind: 'cross' },
};
